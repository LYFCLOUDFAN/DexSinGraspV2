...
class InhandManipulationAllegro(AllegroHand):
    ...
    _keypoints: List[str] = [
        ...
        # "middle_link_0", "middle_link_1", "middle_link_2", "middle_link_3", "middle_biotac_tip",     # finger 1 (middle)
        # "ring_link_0", "ring_link_1", "ring_link_2", "ring_link_3", "ring_biotac_tip",   # finger 2 (ring)
    ]
    _keypoints_info_path: str = "assets/urdf/allegro_touch_sensor_keypoints.json" # XXX: one keypointper link for now.
