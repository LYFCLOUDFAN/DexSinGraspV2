...
def get_args(benchmark=False, use_rlg_config=False):
    custom_parameters = [
        ...
        {"name": "--start_line", "type": int, "default": 0,
            "help": "Start line in object_scale yaml"},
        {"name": "--end_line", "type": int, "default": 1,
        ...
        {"name": "--datatype", "type": str, "default": "random",
         ...
         {"name": "--expert_id", "type": int, "default": None, 
         "help": "Expert ID (1: loose random, 2: dense random, 3: loose from file)"},
         {"name": "--separation_dist", "type": float, "default": None, 
         "help": "Separation distance"},
         {"name": "--surrounding_obj_num", "type": int, "default": None, 
         "help": "Number of surrounding objects"},
         {"name": "--save_camera", "type": bool, "default": None, 
         "help": "Save camera"},
         {"name": "--table_dim_z", "type": float, "default": None, 
         "help": "Table dimension z"},
        ]
