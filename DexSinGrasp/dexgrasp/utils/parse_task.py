...
from tasks.state_based_grasp import StateBasedGrasp
...
def parse_task(args, cfg, cfg_train, sim_params, agent_index):
    ...
    if args.task_type == "C++":
        ...
        try:
            ...
            if cfg['env']['env_name'] == "state_based_grasp":
        ...
        if args.task == "OneFrankaCabinet" :
            ...
            # init env model from task RL with vec warpper: env.step(actions), env.reset()
