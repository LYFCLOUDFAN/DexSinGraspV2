...
python src/train.py \
    ...
    split='train' \
    cluster=0 \
    task=InhandManipulationShadow \
    train=InhandManipulationShadowPPO \
    reward_type=task+curiosity \
    sim_device=cuda:0 \
    rl_device=cuda:0 \
    physics_engine=physx \
    --cfg_train=InhandManipulationShadowPPO \
    --seed=42 \
    --exp_name='PPO' \
    --logdir='shadow_inhand_ppo' \
    --run_device_id=0 \
    --web_visualizer_port=-1 \
    --con \
    --model_dir=/home/nus/DexSinGraspV2/logs/PPO/09-06-22-31_shadow_inhand_ppo_objtype:all_labeltype:in_hand_manipulation_shadow_objnum:1_objcat:pen_maxpercat:-1_geo:all_scale:all_envnum:4096_rewtype:task+curiosity_seed42 \
    # --model_dir=/home/nus/DexSinGraspV2/logs/PPO/09-07-01-21_shadow_inhand_ppo_objtype:all_labeltype:in_hand_manipulation_shadow_objnum:1_objcat:pen_maxpercat:-1_geo:all_scale:all_envnum:4096_rewtype:task+curiosity_seed42 \
    # --model_dir=/home/nus/DexSinGraspV2/logs/PPO/09-06-22-31_shadow_inhand_ppo_objtype:all_labeltype:in_hand_manipulation_shadow_objnum:1_objcat:pen_maxpercat:-1_geo:all_scale:all_envnum:4096_rewtype:task+curiosity_seed42 \
